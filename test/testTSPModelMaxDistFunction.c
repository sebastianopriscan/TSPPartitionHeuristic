...
int main(void)
{
    ...
    *(adjacencies + 12 + 2) = 1 ;
    ...
    struct meta_TSP_instance *metaTspInstance = generate_meta_instance(instance, max_derivation_function) ;
    ...
    *(adjacencies + 20 + 2) = 1 ;
    ...
    metaTspInstance = generate_meta_instance(instance, max_derivation_function) ;
