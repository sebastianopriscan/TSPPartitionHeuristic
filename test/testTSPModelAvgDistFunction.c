...
int main(void)
{
    ...
    *(adjacencies + 12 + 2) = 1 ;
    ...
    struct meta_TSP_instance *metaTspInstance = generate_meta_instance(instance, average_derivation_function_minRec) ;
    ...
    *(adjacencies + 20 + 2) = 1 ;
    ...
    metaTspInstance = generate_meta_instance(instance, average_derivation_function_minRec) ;
